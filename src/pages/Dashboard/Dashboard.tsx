...
const CountdownTimer: React.FC<{
  ...
  return (
    <div className="flex flex-col items-center text-center">
      <div className="bg-gradient-to-r from-red-600 via-orange-500 to-red-600 text-white px-3 py-0.5 rounded-t-md text-[9px] sm:text-[11px] font-bold tracking-wide shadow-md uppercase">
        Referral Offer Ends In
      </div>

      <div className="flex items-center justify-center space-x-1 sm:space-x-1.5 bg-white rounded-b-md shadow-md px-2.5 sm:px-3 py-1 border-t-2 border-red-500">
        {[
          { v: timeLeft.days, l: "D" },
          ...
          <React.Fragment key={l}>
            <div className="bg-gradient-to-br from-red-500 to-orange-500 text-white px-1.5 sm:px-2 py-0.5 rounded-md shadow-inner font-mono font-extrabold text-xs sm:text-sm min-w-[24px] sm:min-w-[28px] text-center">
              {v.toString().padStart(2, "0")}
              <span className="text-[7px] sm:text-[8px] ml-0.5 font-normal">{l}</span>
            </div>
            {i < 3 && (
              <span className="text-red-600 font-extrabold text-sm sm:text-base">:</span>
            )}
          </React.Fragment>
        ))}
      </div>
              ...
              <div className="flex items-start gap-4">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Use your promo code on socials or send directly to patients.
